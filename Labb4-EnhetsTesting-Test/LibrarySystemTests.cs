...
public class LibrarySystemTests
{
    ...
    [TestMethod]
    public void CalculateLateFee_InputtingExistingBookWithAppropriateLateDays_CorrectFeeForLateDays()
    {
        var library = new LibrarySystem();
        var expected = 2.5m;
    ...
    [TestMethod]
    public void CalculateLateFee_InputtingExistingBookWithNegativeLateDays_DecinmalOfZero()
    {
        var library = new LibrarySystem();
        var expected = 0m;
